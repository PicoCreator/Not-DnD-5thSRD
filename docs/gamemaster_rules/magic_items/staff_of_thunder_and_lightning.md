...
This staff can be wielded as a magic quarterstaff that grants a +2 bonus to attack and damage rolls made with it. It also has the following additional properties. When one of these properties is used, it cannot be used again until the next morn.

**Lightning.** When you strike with a melee attack using the staff, you can cause the target to take an extra 2d6 lightning damage.
