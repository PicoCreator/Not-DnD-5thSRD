Description: Rules for interacting with objects from the Oldern World.

# Objects 
When characters need to cut through ropes, break a window, or destroy a vampire's coffin, the only rule is this: given enough time and the right tools, characters can destroy any destructible object. Use common sense when determining a character's success at damaging an object. Could a fighter cut through a section of a stone wall with a sword? No, the sword is likely to break before the wall does.

For the purpose of these rules, an object is a single, inanimate item like a window, door, sword, book, table, chair, or stone, not a building or a vehicle that is composed of many other objects. 
